...
int rValue; //this value checks if restart button is pressed
int pValue; //this value checks if pause button is pressed
...
int state = -1; 
//state will define what screen to display
...
void serialEvent(Serial myPort) {
  ...
  if (rValue == 1) { 
    game.pause();  //pause the currently "game" file currently playing
    game = new SoundFile(this, "game.mp3"); //begin new game soundtrack
    state = -1;     //loading screen displayed
